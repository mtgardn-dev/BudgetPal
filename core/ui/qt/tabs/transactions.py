...
class TransactionsTab(QWidget):
    def __init__(self) -> None:
        ...
        detail_field_width = 840
        detail_label_width = 120
        self.description_input = QLineEdit()
        self.description_input.setPlaceholderText("Description")
        self.description_input.setFixedWidth(detail_field_width)
        self.note_input = QLineEdit()
        self.note_input.setPlaceholderText("Note")
        self.note_input.setFixedWidth(detail_field_width)
        self.payment_type_input = QLineEdit()
        self.payment_type_input.setPlaceholderText("Type")
        self.payment_type_input.setMinimumWidth(160)
        ...
        self.category_input.setFixedWidth(250)
        self.account_input = QComboBox()
        self.account_input.setEditable(False)
        self.account_input.setFixedWidth(250)
        ...
        description_label.setFixedWidth(detail_label_width)
        row2.addWidget(description_label, alignment=Qt.AlignLeft)
        ...
        category_label.setFixedWidth(detail_label_width)
        row3.addWidget(category_label, alignment=Qt.AlignLeft)

        detail_controls = QWidget()
        detail_controls.setFixedWidth(detail_field_width)
        ...
        detail_controls_layout.addWidget(self.category_input, alignment=Qt.AlignLeft)
        detail_controls_layout.addWidget(QLabel("Account"), alignment=Qt.AlignLeft)
        detail_controls_layout.addWidget(self.account_input, alignment=Qt.AlignLeft)
        detail_controls_layout.addWidget(QLabel("Type"), alignment=Qt.AlignLeft)
        detail_controls_layout.addWidget(self.payment_type_input, 1)
        row3.addWidget(detail_controls, alignment=Qt.AlignLeft)
        row3.addStretch(1)
        ...
        note_label.setFixedWidth(detail_label_width)
        row4.addWidget(note_label, alignment=Qt.AlignLeft)
        ...
        expense_heading_row = QHBoxLayout()
        expense_heading_row.setContentsMargins(0, 0, 0, 0)
        expense_heading_row.setSpacing(8)
        expense_heading_row.addWidget(QLabel("Expenses"), alignment=Qt.AlignLeft)
        expense_heading_row.addStretch(1)
        self.expenses_total_label = QLabel("Total: $0.00")
        self.expenses_total_label.setStyleSheet("font-weight: 600;")
        expense_heading_row.addWidget(self.expenses_total_label, alignment=Qt.AlignRight)
        expenses_col.addLayout(expense_heading_row)
        ...
        income_heading_row = QHBoxLayout()
        income_heading_row.setContentsMargins(0, 0, 0, 0)
        income_heading_row.setSpacing(8)
        income_heading_row.addWidget(QLabel("Income"), alignment=Qt.AlignLeft)
        income_heading_row.addStretch(1)
        self.income_total_label = QLabel("Total: $0.00")
        self.income_total_label.setStyleSheet("font-weight: 600;")
        income_heading_row.addWidget(self.income_total_label, alignment=Qt.AlignRight)
        income_col.addLayout(income_heading_row)
