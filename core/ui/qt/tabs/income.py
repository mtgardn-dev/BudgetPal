...
class IncomeTab(QWidget):
    def __init__(self) -> None:
        ...
        self.view_heading = QLabel("Planned Income for")
        ...
        details_layout.addWidget(QLabel("Planned Income Details"))
        ...
        list_layout.addWidget(QLabel("Planned Income"))
        ...
        self.income_definitions_button = QPushButton("Define Planned Income")
        self.refresh_income_button = QPushButton("Refresh Planned Income")
        ...
        total_layout.addWidget(QLabel("Total Planned Income"))
